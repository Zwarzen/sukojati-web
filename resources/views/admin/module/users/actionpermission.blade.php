...
<a href="{{route('admin.users.permission.edit', $id)}}" id="update" data-toggle="tooltip" data-original-title="Update" class="update btn btn-success btn-xs">
	Edit
</a>
...
{{-- <a href="{{route('admin.users.profile.destroy', $id)}}" id="delete" data-toggle="tooltip" data-original-title="Delete" class="delete btn btn-danger btn-xs">
	Delete
</a> --}}
