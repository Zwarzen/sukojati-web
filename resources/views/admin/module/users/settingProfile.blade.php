...
@section('content')
    <form  action="{{route('admin.users.profile.updateProfile') }}" method="post" enctype="multipart/form-data">
        @csrf
  
    <div class="be-content">
      <div class="page-head">
          <h4 class="page-head-title"> Setting Profile<span class="page-head-sub-title"></span></h4>
