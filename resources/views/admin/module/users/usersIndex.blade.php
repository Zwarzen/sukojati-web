...
@section('content')
    ...
    <div class="be-content">
        <div class="page-head">
            <h4 class="page-head-title">Daftar Pengguna<span class="page-head-sub-title"></span></h4>
                        ...
                        <div class="card-body" style="padding:1rem">
                            <div class="row">
                                <div class="col-sm-12">
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a href="{{ route('admin.users.profile.create') }}" class="nav-link">
    ...
    <script>
        $(function() {
            ...
            $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('admin/usersProfile/getlist') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
        ...
        var url = "{{url('admin/usersProfile/delete/')}}"
