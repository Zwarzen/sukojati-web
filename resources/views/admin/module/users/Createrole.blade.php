...
@section('content')
    <form  action="{{route('admin.users.role.storerole') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="be-content">
            <div class="page-head">
                <h4 class="page-head-title"> Tambah Role<span class="page-head-sub-title"></span></h4>
