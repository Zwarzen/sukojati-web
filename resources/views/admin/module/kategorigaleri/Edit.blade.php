...
@section('content')
<form action="{{route('admin.master.kategorigaleri.update', ["id" =>$kategorigaleri->id])}}" method="POST">
  @csrf
        ...
        <div class="card card-table  card-border-color card-border-color-primary">
          ...
          <div class="card-body" style="padding:1rem">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="Nama Ketegori" name="name" value="{{ $kategorigaleri->name }}">
              </div>
            </div>
          </div>
