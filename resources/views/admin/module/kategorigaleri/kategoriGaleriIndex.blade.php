                    ...
                    <div class="card-body" style="padding:1rem">
                        <div class="row">
                            <div class="col-sm-12">
                                <ul class="nav">
                                    <li class="nav-item">
                                      <a href="{{route('admin.master.kategorigaleri.create')}}" class="nav-link">
...
<script >
    $(function() {
        ...
        $('#data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{url('admin/master/kategorigaleri/getlist')}}",
            columns: [
    ...
    function destroyData(id){
        var url = "{{url('admin/master/kategorigaleri/delete/')}}"
