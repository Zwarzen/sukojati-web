...
@section('content')
<form action="{{route('admin.master.kanalberita.update', ["id" =>$kanalberita->id])}}" method="POST">
  @csrf
<div class="be-content">
  <div class="page-head">
    <h4 class="page-head-title">Edit Kanal Berita<span class="page-head-sub-title"></span></h4>
        ...
        <div class="card card-table  card-border-color card-border-color-primary">
          ...
          <div class="card-body" style="padding:1rem">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="Kanal Berita" name="name" 
                value="{{ $kanalberita->name }}">


                <input type="text" readonly 
                style="border:none; font-style:italic; font-size:1rem;" 
                class="form-control" id="slug" placeholder="Slug Judul"
                name="slug" value="{{ isset($kanalberita)?$kanalberita->slug:'' }}">
            <div>Slug ini penting untuk alamat akses atau url identitas, misalnya : <br> www.xeample.go.id/kanal/<i>nama-kanal-ini</i></div>
