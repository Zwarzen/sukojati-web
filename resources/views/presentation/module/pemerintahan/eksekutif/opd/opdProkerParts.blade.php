<div class="pad-main-resume">
    ...
    <div class="sg-title">
        <div class="sg-ic-wrp">
            ...
            <div class="sg-text">PROGRAM KERJA</div>
        </div>
...
<article class=" container article-justify">
...
<h2 class="container" style="background: #4ea1ac; padding:1rem; ">Catatan:: konten halaman ini silakan merujuk pada web 
