...
<div class="pad-main-resume">
    ...
    <div class="modul-title">
        <div class="modul-ic-wrp">
            <img class="modul-ic" src="{{ asset('presentation/b-asset/img/icon-wisata.png') }}" alt="">
            <div class="modul-text">Wisata</div>
        </div>
    ...
    <div style="display:flex;  flex-direction:row">
        <div style="padding:1rem; flex:1">
            <form action="#" style="color:white; margin:auto; align-self:center auto; flex:1"
                ...
                <input class="form-control  search-input-form" type="text" placeholder="Mencari sesuatu di Wisata... ">
                <i styl="clear:both"></i>
            </form>
        </div>
    </div>
