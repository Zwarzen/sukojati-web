...
@section('pageContent')
    ...
    <div id="ctn-utama" class="based-div-1">
        ...
        <div id="main-content"
            ...
            <div id="p-1"
                style="max-width:100vw !important; overflow-x:hidden;  background: linear-gradient(to top, #ffffff 1%,#ffffff60,#ffffff00)">
                ...
                <div class="typewriter title-text-single">
            ...
            <div id="p-2" class="" style="scroll-behavior: smooth; min-height: 100vh; padding-top:50px">
                <div id="p-2-inner">
                    ...
                    {{-- <div class="label-search">Kulik Informasi Menarik</div> --}}
                        ...
                        <div style="padding:1rem; margin:auto; cursor:pointer">
                            <div style="padding:1rem; margin:auto">
                                <form action="#" style="color:inherit; margin:auto; align-self:center auto;"
                                    ...
                                    <input readonly id="search-input-form" data-trigger="#navbar_main_search"
                                        class="form-control search-input-form" type="text" placeholder="Cari info menarik ">
                                    <i style="clear:both"></i>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="">
                                    ...
                                    <a target="_blank"
                                        ...
                                        <div
                                            style="display: flex; flex-direction:row; padding:0.5rem;  background: #ffffff5b; opacity:0.9; border-radius:20px;">

                                            <div style="flex:1; padding-right:1rem;">
                                                <div style="text-align: left; font-size:1rem">
                                                    <strong>Diguyur Hujan, Banyuwangi Ijen Geopark Downhill Semakin
                                                        Seru</strong>
                                                ...
                                                <div style="height: 0.5rem"></div>
                                                <div style="text-align:left; font-size:0.7rem;">BANYUWANGI-Hujan deras
                                                    membuat
                                                    pelaksanaan babak final Banyuwangi Ijen Geopark Downhill 2021, di
                                                    lintasan
                                                    Gantasan Bike Park, ....
                                                </div>
                                            ...
                                            <div style="height: 7rem; width:7rem; border-radius:1rem;   
                                                                        background-image: url('https://banyuwangikab.go.id/media/berita/images/2db56a734934ba4fe6d5876ac177693f.jpg');
                                                                        background-size:100% 100%;
                                                                        background-position:center center; ">
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div
                                    style=" border-radius:15px; background: #ffffff5b; opacity:0.9; padding:1rem; width:100%;">
                                    <div style="opacity: 1 !important; ">
                                        ...
                                        <div class="row">
                                            <div class="col-6 col-lg-6 col-md-6">
                                                <div>
                                                    <div style="color: #0888af; font-size:1rem">
                                                        <a style="color: inherit !important" href="https://smartkampung.id/">
                                                            Persuratan
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <span> <strong>1.799</strong> </span> <small>Bulan ini</small>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6 col-lg-6 col-md-6">
                                                ...
                                                <div>
                                                    <div style="color: #0888af; font-size:1rem">
                                                        <a style="color: inherit !important" href="http://pengaduan.banyuwangikab.go.id/">
                                                            Pengaduan
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <span> <strong>1.502</strong> </span> <small>Bulan ini</small>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div
                                    ...
                                    <div style="opacity: 1 !important; ">
                                        ...
                                        <div>
                                            <div style="color: #0888af; font-size:1rem">
                                                <a style="color: inherit !important" href="#">
                                                    Kunjugan kerja ke Desa
                                                </a>
                                            </div>
                                            <div>
                                                <small>Sosialisasi Program Petani Mandiri ...</small>
                                            </div>
                                        </div>
                                        <hr>
                                        <div>
                    ...
                    <div class="container">
                        @include('presentation.module.home.portal.prioritasNewParts')
                    </div>
            ...
            <div id="p-3" style="background: linear-gradient(transparent,#3d3d3d)">
                                        ...
                                        @php
                                            $listApps = [
                                                ...
                                                [
                                                    ...
                                                    'imgSrc' => asset('presentation/b-asset/img/icon-bwimap.png'),
                                                    'textDesc' => '  ',
                                                    'justForward' => true,
                                                ],
                ...
                <div style="
                                        ...
                                        background: linear-gradient(to bottom, #05c98e,#05c98e); 
                                        -ms-transform: skewY(-3deg); /* IE 9 */
                                        -webkit-transform: skewY(-3deg); /* Safari */
                                        transform: skewY(-3deg); /* Standard syntax */
                                        border:none;
                    ...
                    <div style="
                        ...
                        width:20rem; 
                        opacity:0.1;
                        background: url('{{ asset('presentation/b-asset/img/gajah_oling_soft_small.png') }}');
                            ...
                            @php
                                $listApps = [
                                    ...
                                    [
                                        ...
                                        'linkTo' => '#',
                                        'imgSrc' => asset('presentation/b-asset/img/icon-bwimap.png'),
                                        'textDesc' => 'Daftar inovasi yang telah dikembangkan demi melestarikan budaya banyuwangi serta mendidik generasi selanjutnya (misalnya kamus bahsa osing, dll) ',
                                        'justForward' => true,
                                        'action' => 'popup',
                                        'parameter' => [
                                            'link' => '',
                ...
                <div style="
                        opacity:0.8 !important;   
                        transform:rotate(-2deg); 
                        background: linear-gradient(to bottom,#daba07,#daba07); 
                        -ms-transform: skewY(-3deg); /* IE 9 */
                        -webkit-transform: skewY(-3deg); /* Safari */
                        transform: skewY(-3deg); /* Standard syntax */
                        border:none;
                    ...
                    <div style="
                                ...
                                width:20rem;
                                opacity:0.1;
                                background: url('{{ asset('presentation/b-asset/img/biji-coffee.png') }}');
                                background-size:cover;
                                background-repeat:no-repeat"></div>
                ...
                {{-- 4 --}}
                <div style="background: linear-gradient(to bottom,#dc07e4,#dc07e4); 
                                    opacity:0.8 !important; 
                                    width:100%; 
                                    position: relative; 
                                    z-index:9;
                    ...
                    <div style="
                            ...
                            width:20rem;
                            opacity:0.2;
                            background: url('{{ asset('presentation/b-asset/img/kuliner.png') }}');
                            background-size:cover;
                            background-repeat:no-repeat"></div>
