        ...
        <div id="main-content"
            ...
            <div id="p-1"
                ...
                <div class="apcr-top-wrp">
                    ...
                    @if(isset($corona))
                        ...
                        <a class="apcr-top-item right" 
                            href="{{ url('/#corona_field') }}"
                            onclick="document.getElementById('p-2').scrollIntoView({'behavior': 'smooth'});return false;">
                            <img class="apcr-top-item right" style="border-radius:5px" src="{{ asset('presentation/b-asset/img/icon-info-covid.png') }}"
                            alt="">
                    ...
                    <img class="apcr-top-item left"  style="padding:2px;" src="{{ asset('presentation/b-asset/img/bwi_rebound_black.png') }}" alt="">
            ...
            <div id="p-2" class="" style="scroll-behavior: smooth; min-height: 100vh; padding-top:50px">
                <div id="p-2-inner">
                    ...
                    @if(isset($corona))
                    <div class="container" id="corona_field">
                                ...
                                <div class="">
                                    ...
                                    <a target="_blank" href="https://corona.banyuwangikab.go.id/">
                                        <div {{-- box-shadow: 0 1px 20px rgb(0 0 0 / 0.1); --}}
                                            style="display: flex; flex-direction:row; padding:0.5rem;  background: #fffffff3; opacity:0.9; border-radius:15px;">
                                            <div
...
{{-- 
                    ...
                    <div class="container" style="z-index: 2; position: relative;">
                        @include('presentation.module.home.portal.galleryParts',["galeriKategori"=>isset($galeriKategori)?$galeriKategori:null])
                    </div>
...
@section('footer')
    ...
    <script>
        ...
        function getListPopUpInfo() {
            
            $.ajax({
                type: 'GET',
                url: APP_URL + '/portal/list-popupinfo',
                dataType: "html",
