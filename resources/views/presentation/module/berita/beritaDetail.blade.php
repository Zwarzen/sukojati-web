...
@section('pageContentArtikel')
    <link itemprop="thumbnailUrl"
        href="{{ $beritaDetail->img_thumb != '' || $beritaDetail->img_thumb != null ? $base_link_media_thumbnail . $beritaDetail->img_thumb : asset('presentation/b-asset/img/lambang-daerah.png') }}">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-lg-8 col-md-12">
                <article>
                    <header>
                        <h1 class="title-detail-berita">{{ $beritaDetail->title }}</h1>
                    </header>
                    ...
                    <h2> <small style="font-size: 0.9rem">
                            ...
                            {{ \Carbon\Carbon::parse($beritaDetail->created_at)->isoFOrmat('dddd, D MMMM Y') }} </small>
                    </h2>
                    <br>

                    <div class="img-detail-berita-wrp">
                        <img class="img-detail-berita"
                            src="{{ $beritaDetail->img_thumb != '' || $beritaDetail->img_raw != null ? $base_link_media_raw . $beritaDetail->img_raw : asset('presentation/b-asset/img/lambang-daerah.png') }}" />
                        <div style="text-align:left; max-width:300px">
                            <small><i>{{ strlen($beritaDetail->img_desc) > 10 ? $beritaDetail->img_desc : '' }}</i></small>
                        </div>
                    </div>
        ...
        {{-- @if (isset($beritaRelated) && count($beritaRelated) > 0)
            ...
            <aside>
                ...
                <br>
                <nav>
                    <a class="btn default" href="{{ route('berita') }}" style="color:blue !important"> <i
