                    ...
                    <div class="container">
                        ...
                        <div class="row">
                                    ...
                                    @foreach ($latestBerita as $item)
                                        <a href="{{ route('berita') . '/' . $item->slug }}">
                                            <div class="banner-top-wrp">
                                                <div style=" background:url('{{ $item->img_raw != '' || $item->img_raw != null ? $base_link_media_raw . $item->img_raw : asset('presentation/b-asset/img/lambang-daerah.png') }}');"
                                                ...
                                                <div class="bti-title">
                                                    ...
                                                    <div class="xsub-bti-title">
                                                        <span style="font-size:0.8rem">
                                                            ...
                                                            <i class="fas fa-bookmark"></i> {{ $item->kanal_name }}
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div style="background: #fafafa00; border-radius:15px;  margin-bottom:1rem">
                                    @include('presentation.module.berita.ngetrenBerita', [
                                        'base_link_media_thumbnail' => $base_link_media_thumbnail,
                                        'ngetrenBerita' => $ngetrenBerita,
                                    ])
                                </div>
                            </div>
                        ...
                        {{-- <div style="height:2rem"></div>
                        <div class="container">
                            @include('presentation.module.berita.beritaPartVideoTerbaru',["base_link_media_thumbnail"=>$base_link_media_thumbnail,"latestBeritaVideo"=>isset($latestBeritaVideo)?$latestBeritaVideo:null])
                        </div> --}}

                        {{-- <div style="height:2rem"></div>
                        <div style="text-align: center">
                            <a href="{{ route("berita.video") }}">
                                <button class="btn" style="padding:1rem; border-radius: 15px; background:#fafafa !important;">Berita video lainnya</button>
                            </a>
                            ...
                            <div style="background: #fafafa; border-radius:15px; padding:1rem; margin-bottom:1rem">
                                <div style="font-size:1.2rem; font-weight:600">{{ $item['title'] }}
                                    {{-- <a href="{{ route('berita.kanal.{any}', $item['kanal_slug']) }}">
                                        ...
                                        <small style="float: right; font-size:0.9rem; line-height:2rem">Lainnya <i
                                ...
                                <div class="row">
                                    {{-- <div class="col-12 col-md-4 col-lg-4">
                                        <a target="_blank" href="{{ route('berita') . '/' . $item['pinned']['slug'] }}">
                                                ...
                                                <div style="
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div>{{ $item['pinned']['title'] }}</div>
                                                            <div style="color:#8b8b8b"><small>{{ \Carbon\Carbon::parse($item['pinned']['publish_date'])->diffForHumans() }}</small></div>
                                    ...
                                    {{-- <div class="col-12 col-md-4  {{ isset($item['populer'])? 'col-lg-4'  : 'col-lg-8' }}"> --}}
                                    <div class="col-12 }}">
                                            ...
                                            @if (isset($item['terbaru']))
                                                @foreach ($item['terbaru'] as $items)
                                                    <a target="_blank" style="margin-bottom: 1rem"
                                                        href="{{ route('berita') . '/' . $items['slug'] }}">
                                                        <div class="ng-wrp-item" style="border-bottom: 1px solid #e9e9e9">
                                                            <div
                                                                style="height: 5rem; width:5rem; border-radius:15px;
                                        ...
                                        <div
                                            style="text-align:center; font-size:0.9rem; margin-top:1rem; margin-bottom:1rem">
                                            {{-- <a href="{{ route('berita.kanal.{any}', $item['kanal_slug']) }}">Lihat
                                                lainnya</a> --}}
                                        </div>
                                    </div>

                                    {{-- @if (isset($item['populer']))
                                        @if (count($item['populer']) > 0)
                                            <div class="col-12 col-md-4 col-lg-4">
