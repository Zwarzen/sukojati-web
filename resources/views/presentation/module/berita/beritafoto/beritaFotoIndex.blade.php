        ...
        <div id="main-content"
            ...
            <div id="p-2" class="" style="scroll-behavior: smooth; min-height: 100vh; padding-top:50px">
                <div id="p-2-inner">
                    ...
                    <div class="container">
                        <div style="text-align:center; font-size: 2rem; font-weight:600">Berita Foto </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-md-8 col-lg-8">
                                <div class="owl-carousel owl-theme" id="dt-banner-top-pp-2"
                                    ...
                                    @foreach ( $latestBerita as $item)
                                        @if($item->jml_fotos > 0)
                                            <a href="{{ route('berita.foto') . '/' . $item->slug }}"> 
                                                <div class="banner-top-wrp">
                                                    <div style=" background:url('{{ $item->img_raw_nya != '' || $item->img_raw_nya != null? $base_link_media_raw.$item->img_raw_nya : asset('presentation/b-asset/img/lambang-daerah.png') }}');"
                                                        class="banner-top-item ">
                                                        {{-- <div
                                                            style=" padding:0.5rem; font-size:2rem; background: linear-gradient(to right,#3333334b,#33333327,#33333300 ); color:#ffffff">
                                                            {{ $item->jml_fotos }} <i class="fas fa-images"></i>
                                                        </div> --}}
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div style="background: #fafafa; border-radius:15px;  margin-bottom:1rem">
                                    ...
                                    ["base_link_media_thumbnail"=>$base_link_media_thumbnail, "ngetrenBeritaFoto"=>$ngetrenBeritaFoto])
                                </div>
                            </div>
                        ...
                        @foreach ($beritaPartsKategori as $item)
                            ...
                            <div style="background: #fafafa; border-radius:15px; padding:1rem; margin-bottom:1rem">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <a target="_blank" href="{{ route('berita.foto') . '/' . $item['pinned']['slug'] }}">
                                            <div style="width: 100%; height:350px; padding:0px;">
                                                ...
                                                <div style="
                                                            ...
                                                            background-image:url('{{ $item['pinned']['img_thumb_nya'] != '' || $item['pinned']['img_thumb_nya'] != null? $base_link_media_thumbnail.$item['pinned']['img_thumb_nya'] : asset('presentation/b-asset/img/lambang-daerah.png') }}');
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <small>
                                                                <i class="fas fa-images"></i> 
                                                            {{ $item['pinned']['jml_fotos'] }} foto pada 
...
{{--                                           
                                            @if(isset($item['populer']))
                                                @foreach ($item['populer'] as $items)
                                                    <a target="_blank" href="{{ route('berita.foto') . '/' . $items['slug'] }}">
                                                        <div class="ng-wrp-item" style="border-bottom: 1px solid #e9e9e9">
                                                            <div style="height: 5rem; width:5rem; border-radius:15px;   
                                                                background-image: url('{{ $items['img_thumb_nya'] != '' || $items['img_thumb_nya'] != null? $base_link_media_thumbnail .$items['img_thumb_nya'] : asset('presentation/b-asset/img/lambang-daerah.png') }}');
                                                                background-size:cover;
                                                                background-repeat:no-repeat; 
                                                                background-position:center center; ">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        ...
                                        @foreach ($item['terbaru'] as $items)
                                                <a target="_blank" style="margin-bottom: 1rem"
                                                    href="{{ route('berita.foto') . '/' . $items['slug'] }}">
                                                    <div class="ng-wrp-item" style="border-bottom: 1px solid #e9e9e9">
                                                        <div style="height: 5rem; width:5rem; border-radius:15px;   
                                                            background-image: url('{{ $items['img_thumb_nya'] != '' || $items['img_thumb_nya'] != null? $base_link_media_thumbnail .$items['img_thumb_nya'] : asset('presentation/b-asset/img/lambang-daerah.png') }}');
                                                            background-size:cover;
