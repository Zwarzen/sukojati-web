        ...
        <div id="main-content"
            ...
            <div id="p-2" class="" style="scroll-behavior: smooth; min-height: 100vh; padding-top:50px">
                <div id="p-2-inner">
                    ...
                    <div class="container">
                        <div style="text-align:center; font-size: 2rem; font-weight:600">Kanal video {{ $kanal->name }} </div>
                    </div>
                                                ...
                                                <div class="bti-title">
                                                    ...
                                                    <div class="xsub-bti-title">
                                                        <span style="font-size:0.8rem">
                                                            {{-- {{ $val['kanal-name'] }} | --}}
                                                             <i class="fas fa-calendar-alt"></i> {{ \Carbon\Carbon::parse($item->created_at)->format("Y-m-d") }}  </span>
                                                    </div>
                    ...
                    <div class="container">
                        ...
                        <div style="width: 100%; font-size:1.2rem; font-weight:600; line-height:2rem; padding:0.5rem"> 
                            Sebaran dari kanal video {{ $kanal->name }}
                        </div>


                        <div class="scroller" >

                            @if (isset($listBeritaKanal))
                            <div style="border-radius:15px; background:#fafafa; padding:1rem;">
                                @foreach ($listBeritaKanal as $items)
                                    <a target="_blank" href="{{ route('berita') . '/' . $items->slug }}">
                                        <div class="ng-wrp-item" style="background:transparent; border-bottom: 1px solid #fafafa">
                                            ...
                                            <div style=" flex:1;padding-left:1rem;">
                                                <div style="text-align: left; font-weight:600; color:#565fdd">
                                                    {{ $items->title }}
                                                    <br>
                                                ...
                                                {{ \Carbon\Carbon::parse($items->created_at)->format("Y-m-d") }}
                                                {{ strlen($items->desc) >10? strlen($items->desc) :   $items->title   }}
                                                </div>
                                ...
                                <div>{{ $listBeritaKanal->links("pagination::bootstrap-4") }}</div>
