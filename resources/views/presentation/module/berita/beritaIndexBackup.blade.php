...
@section('pageContent')
    <div id="ctn-utama" class="based-div-1">
        <div style="
            background:linear-gradient(10deg, #bbbbbb 1%,  #eeeeee, #eeeeee); 
            opacity:1; content:'';  
        ...
        <div id="main-content"
            ...
            <div id="p-2" class="" style="scroll-behavior: smooth; min-height: 100vh; padding-top:50px">
                <div id="p-2-inner">
                    ...
                    <div class="container">
                        <div style="text-align:center; font-size: 2rem; font-weight:600"> Kabar Banyuwangi </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div style="background: #fafafa; border-radius:15px;  margin-bottom:1rem">
                                    @include('presentation.module.berita.ngetrenBerita',["base_link_media_thumbnail"=>$base_link_media_thumbnail, "ngetrenBerita"=>$ngetrenBerita])
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="scroller" style="max-height:27rem; overflow-y:auto;">
                                            ...
                                            <a target="_blank" href="{{ route('berita') . '/' . $items['slug'] }}">
                                        ...
                                        <div style="text-align:center; font-size:0.9rem; margin-top:1rem; margin-bottom:1rem">
                                            <a href="{{ route('berita.kanal.{any}',$item['kanal_slug']) }}">Lihat lainnya</a>
                                        </div>
