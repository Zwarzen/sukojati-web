                ...
                <a class="navbar-brand" href="{{ url('/berita')  }}">
                    <div style="display: flex; flex-direction:row;">
                        ...
                        <div id="title-teks" class="logo-beranda">
                            <span class="title-teks-sub-a">{{ isset($navigationPart["navBrandTitle"]) ? $navigationPart["navBrandTitle"] : 'BERITA' }}</span>
                            <span class="title-teks-sub-b">{{ isset($navigationPart["navBrandSubTitle"]) ? $navigationPart["navBrandSubTitle"] :'Banyuwangi' }} </span>
                        </div>
                    </div>
                </a>
