            ...
            <nav class="navbar navbar-expand-lg ">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div style="display: flex; flex-direction:row;">
                        ...
                        <div id="title-teks" class="logo-beranda">
                            <span class="title-teks-sub-a">BANYUWANGIKAB<span class="p-goid">.GO.ID</span></span>
                ...
                <nav id="navbar_main" class="ml-auto mobile-offcanvas navbar navbar-expand-lg navbar-dark ">
                    <div class="offcanvas-header">
                        ...
                        <a class="navbar-brand" href="{{ url('/') }}">
                            <div style="display: flex; flex-direction:row;">
                                <img src="{{ asset('srcadmin/b-assets/img/logo_bwi.png') }}" class="logo-beranda-img">
                                <div id="title-teks" class="logo-beranda">
                                    <span class="title-teks-sub-a">BANYUWANGIKAB <span
                                            class="p-goid">.GO.ID</span> </span>
                                    <span class="title-teks-sub-b">Semakin Digital</span>
                                </div>
                            </div>
                        </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/pemerintahan') }}">
                                Pemerintahan
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/prioritas') }}">
                                Prioritas
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/warga') }}">
                                Warga
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/layanan') }}">
                                Layanan
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/wisata') }}">
                                Wisata
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/budaya') }}">
                                Budaya
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/bisnis') }}">
                                Bisnis
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/berita') }}">
                                Berita
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link a-nav" href="{{ url('/akun') }}">
                                Akun
                            </a>
                        </li>
