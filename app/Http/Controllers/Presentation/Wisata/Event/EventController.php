...
namespace App\Http\Controllers\Presentation\Wisata\Event;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Models\Presentation\Wisata\Event;


class EventController extends Controller
{
    public $nmPart = "presentation.module.wisata.event.";
    ...
    public function index()
    {
        ...
        //opsi ini diisi dengan judul halaman yang sesuai
        // bisa dari database atau diisi manual
        $data['pageTitle'] = "Event kabupaten Banyuwangi";
        ...
        $data['keywords'] = "event banyuwangi, acara banyuwangi, kegiatan banyuwangi, jadwal acara event banyuwangi";
        ...
        $data['modulItems'] = [
            ...
            [
                "name" => "Tips Menjadi Wisatawan Banyuwangi",
                "icon" => asset('presentation/b-asset/img/icon-wisata.png'),
                "link" => url($uriModul.'/tempat-bersejarah'),
                "desc" => "Tempat-tempat sejarah",
        ...
        return view($this->nmPart."eventIndex",$data);
    }
