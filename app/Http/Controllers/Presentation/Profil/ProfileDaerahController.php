...
class ProfileDaerahController extends Controller
{
    ...
    public  function __construct(Request $request){
        ...
        //opsi ini diisi dengan judul halaman yang sesuai 
        // bisa dari database atau diisi manual
        $this->data['pageTitle'] = "Profil Daerah Banyuwangi";
    ...
    public function index(){
        ...
        return view($this->nmPart."profilIndex",$data);
    }

    public function kinerja(){
        $this->data['pageTitle'] = "Kinerja Daerah Banyuwangi";
        $data = $this->data;
        
        return view($this->nmPart."profilKinerjaIndex",$data);
    }

    public function iklim(){
        $this->data['pageTitle'] = "Iklim Daerah Banyuwangi";
        $data = $this->data;
        return view($this->nmPart."profilIklimIndex",$data);
    }

    public function sejarah(){
        $this->data['pageTitle'] = "Sejarah Daerah Banyuwangi";
        $data = $this->data;
        
        return view($this->nmPart."profilSejarah",$data);
    }


    public function geografi(){
        $this->data['pageTitle'] = "Geografi Daerah Banyuwangi";
        $data = $this->data;
        
        return view($this->nmPart."profilGeografiIndex",$data);
    }

    public function geologi(){
        $this->data['pageTitle'] = "Geologi Daerah Banyuwangi";
        $data = $this->data;
        
        return view($this->nmPart."profilGeologiIndex",$data);
    }
