...
class BeritaController extends Controller
{
    ...
    public function __construct(Request $request, Berita $berita, KanalBerita $kanalBerita, Indexs $indexs, OpdUser $opduser)
    {
        $this->berita = $berita;
    ...
    public function index(){
        ...
        if($unors->count()>0){
            ...
            session()->now('warning', 'Unor / Organisasi tidak ditemukan, Anda Tidak Terdaftar Pada salah satu OPD / SKPD.');
